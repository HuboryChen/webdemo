...
<body class="gray-bg">
    	...
    	<div class="row xtlhpm-zone">
			<div class="col-sm-2 xtlhpm-add">
        		<div class="ibox pa-add">
                      <a href="addpdresult.jsp" target="_blank">新增考评结果</a>
        		</div>
        	</div>
			...
			<table  data-toggle="table"  data-query-params="queryParams" data-mobile-responsive="true" data-height="400"  data-icon-size="outline" >
                <thead >
                    <tr >
                        ...
                        <th data-field=" 2" class="text-center">考官</th>
                        <th data-field=" 3" class="text-center">团队成员姓名</th>
                        <th data-field=" 4"  class="text-center">成绩</th>
                        <th data-field=" 5" class="text-center">等级</th>
                        <th data-field="6 " class="text-center">考核时间</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>A级</td>
                        <td>2018-02-23</td>
                        <td class="specialcolor"><a href="pddetail.jsp" target="_blank">详情</a><a href=".jsp" target="_blank">修改</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    $(function(){
      $("#id").click(function(){
            window.location.href="addpdresult.jsp";
        });
    });
